  ...
  const yourBatch = [
    {
      ...
      batchLink: "/student/batchs/1",
      batchLogo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXJtffi-iw9cRgis8PZn02J1zISnTsoHB64Q&s",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      batchDescription:
        "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum animi porro dolores eveniet eos perspiciatis atque minima dolore dicta vero.",
      batchLink: "/student/batchs/3",
      batchLogo:
        "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQXJtffi-iw9cRgis8PZn02J1zISnTsoHB64Q&s",
    },
  ];

  const similarBatches = [
    {
      id: 1,
      batchTitle: "batch Title 1",
      batchDescription:
        "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum animi porro dolores eveniet eos perspiciatis atque minima dolore dicta vero.",
      batchLink: "/student/batchs/1",
      batchLogo: "https://img-b.udemycdn.com/course/240x135/100536_4997_4.jpg",
      batchPrice: "$20",
    ...
    {
      id: 5,
      batchTitle: "batch Title 5",
      batchDescription:
        "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Rerum animi porro dolores eveniet eos perspiciatis atque minima dolore dicta vero.",
      batchLink: "/student/batchs/5",
      batchLogo: "https://img-b.udemycdn.com/course/240x135/100536_4997_4.jpg",
      batchPrice: "$20",
      startingDate: "12/12/2021",
      enrolledStudents: 100,
        ...
        <div className="flex-1 p-8 max-h-screen bg-gradient-to-br from-pink-50 to-pink-100 overflow-y-scroll">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {yourBatch.map((batch) => {
                return (
                  <Link key={batch.id} to={batch.batchLink}>
                    ...
                    <div className="flex justify-between items-center mb-3">
                      <div className="flex items-center gap-2">
                        <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#FF006B] to-pink-500">
                          <img
                            src={batch?.instrucrorImage}
                            alt={batch.instractor}
