...
export default function VideoClass() {
  ...
  return (
    <div className="flex items-center h-screen">
        {/* <Navbar/> */}
      <div className="container flex h-[80vh] m-auto bg-white !rounded-[20px] border-none my-10">
        <div className="flex-1 flex flex-col !rounded-[20px]">
          ...
          <div className="pb-10 flex justify-center border-none">
            ...
            <Button variant="destructive" size="icon" className= "!bg-[#FF006B] text-white w-16 rounded-[20px] mx-1">
